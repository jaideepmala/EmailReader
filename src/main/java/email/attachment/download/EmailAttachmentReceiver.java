package email.attachment.download;
...
public class EmailAttachmentReceiver {
     ...
     * @param password
     */
    private void downloadEmailAttachments(String host, String port,
        ...
        try {
            ...
            Folder folderInbox = store.getFolder("mylabel");
    ...
    /**
     * Runs this program with Gmail imap server
     */
